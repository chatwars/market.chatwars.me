...
(function(angular){
    "use strict";
    IndexCtrl.$inject = ["$scope", "$stateParams", "$mdToast", "StaticService", "$mdSidenav"];
    angular.module('cwm')
...
angular.module("cwm.templates", []).run(["$templateCache", function($templateCache) {$templateCache.put('index/index.html','<md-sidenav class="md-sidenav-left" md-component-id="left" md-whiteframe="4"><md-toolbar class="md-theme-light"><h1 class="md-toolbar-tools">Chat Wars Market</h1></md-toolbar><md-content layout-padding="layout-padding" layout="column"><md-input-container><label class="md-no-float"></label><input type="text" ng-model="vm.query.filter" ng-model-options="vm.filter.options" placeholder="\u041F\u043E\u0438\u0441\u043A \u043F\u043E \u0438\u043C\u0435\u043D\u0438 \u0438\u0433\u0440\u043E\u043A\u0430"/></md-input-container><md-chips flex="flex" ng-model="vm.filterByItems" readonly="false" md-removable="true" md-max-chips="5" md-autocomplete-snap="md-autocomplete-snap" md-require-match="true" ng-click="vm.focus($event)"><md-chip-template><strong>{{$chip}}</strong></md-chip-template><md-autocomplete md-selected-item="vm.selectedItem" md-search-text="vm.searchText" md-items="item in vm.querySearch(vm.searchText)" md-item-text="item" placeholder="\u041F\u043E\u0438\u0441\u043A \u043F\u043E \u043F\u0440\u0435\u0434\u043C\u0435\u0442\u0443"><span md-highlight-text="vm.searchText">{{item}}</span></md-autocomplete></md-chips><md-switch class="md-primary" ng-model="vm.logic" aria-label="Logic Or/And">{{vm.logicText[vm.logic]}}</md-switch><md-button class="md-primary" ng-click="vm.toggleSidenav()">\u0417\u0430\u043A\u0440\u044B\u0442\u044C</md-button></md-content></md-sidenav><md-toolbar class="md-table-toolbar md-default" id="toast-container" hide-xs="hide-xs" show-gt-xs="show-gt-xs"><div class="md-toolbar-tools"><div layout="row" layout-align="start center" flex="50"><md-icon>search</md-icon><form flex="flex"><label class="md-no-float"></label><input type="text" ng-model="vm.query.filter" ng-model-options="vm.filter.options" placeholder="\u041F\u043E\u0438\u0441\u043A \u043F\u043E \u0438\u043C\u0435\u043D\u0438 \u0438\u0433\u0440\u043E\u043A\u0430"/></form><md-button ng-click="vm.clearFilter()"><md-icon>close</md-icon></md-button></div><div layout="row" layout-align="end center" flex="50"><md-chips flex="flex" ng-model="vm.filterByItems" readonly="false" md-removable="true" md-max-chips="5" md-autocomplete-snap="md-autocomplete-snap" md-require-match="true" ng-click="vm.focus($event)"><md-chip-template><strong>{{$chip}}</strong></md-chip-template><md-autocomplete md-selected-item="vm.selectedItem" md-search-text="vm.searchText" md-items="item in vm.querySearch(vm.searchText)" md-item-text="item" placeholder="\u041F\u043E\u0438\u0441\u043A \u043F\u043E \u043F\u0440\u0435\u0434\u043C\u0435\u0442\u0443"><span md-highlight-text="vm.searchText">{{item}}</span></md-autocomplete></md-chips><md-switch class="md-primary" ng-model="vm.logic" aria-label="Logic Or/And">{{vm.logicText[vm.logic]}}</md-switch></div></div><md-divider></md-divider></md-toolbar><div layout="row" style="overflow: auto;"><md-content flex="flex" layout-padding=""><md-table-pagination class="no-border" md-limit="vm.pagination.limit" md-limit-options="[20, 50, 100]" md-page="vm.pagination.page" md-total="{{filtered.length}}" md-page-select="vm.options.pageSelect" md-label="{{vm.pagination.label}}"></md-table-pagination><md-table-container><table md-table="md-table" ng-model="vm.selected" md-progress="vm.promise"><thead md-head="md-head" md-order="vm.query.order"><tr md-row="md-row"><th md-column="md-column" md-order-by="leftUser.name"><span>\u042E\u0437\u0435\u0440 1</span></th><th md-column="md-column"><span>\u041F\u0440\u0435\u0434\u043C\u0435\u0442\u044B</span></th><th md-column="md-column"><span>\u041F\u0440\u0435\u0434\u043C\u0435\u0442\u044B</span></th><th md-column="md-column" md-order-by="rightUser.name"><span>\u042E\u0437\u0435\u0440 2</span></th><th md-column="md-column" md-order-by="issuedAt"><span>\u0414\u0430\u0442\u0430</span></th></tr></thead><tbody md-body="md-body"><tr md-row="md-row" ng-repeat="row in filtered = (vm.data|byName:vm.query.filter|items:vm.filterByItems:vm.logic) |orderBy: vm.query.order|limitTo: vm.pagination.limit: (vm.pagination.page - 1) * vm.pagination.limit" md-select="row" md-select-id="$index" md-auto-select="vm.options.autoSelect" ng-style="{\'background-color\':row.color}"><td md-cell="md-cell" ng-bind-html="row.leftUser.name|emoji"></td><td class="item-list" md-cell="md-cell"><ul><li ng-repeat="(item, cnt) in row.leftToRight" ng-click="vm.filterItem(item)">{{item}}<span class="badge">{{cnt}}</span></li></ul></td><td class="item-list" md-cell="md-cell"><ul><li ng-repeat="(item, cnt) in row.rightToLeft" ng-click="vm.filterItem(item)">{{item}}<span class="badge">{{cnt}}</span></li></ul></td><td md-cell="md-cell" ng-bind-html="row.rightUser.name|emoji"></td><td md-cell="md-cell">{{row.issuedAt|udate}}</td></tr></tbody></table></md-table-container><md-table-pagination md-limit="vm.pagination.limit" md-limit-options="[20, 50, 100]" md-page="vm.pagination.page" md-total="{{filtered.length}}" md-page-select="vm.options.pageSelect" md-label="{{vm.pagination.label}}"></md-table-pagination><div flex=""></div></md-content></div>');
$templateCache.put('header/header.html','<md-toolbar class="md-hue-2 navbar-fixed"><div class="md-toolbar-tools" show-xs="show-xs" hide-gt-xs="hide-gt-xs" layout-xs="row"><md-button class="md-icon-button" aria-label="Settings" ng-click="vm.toggleSidenav()"><md-icon>menu</md-icon></md-button><div layout-xs="column" layout-align-xs="end center"><h6>Chat Wars Market <br> \u0421\u043F\u0438\u0441\u043E\u043A \u043E\u043F\u0435\u0440\u0430\u0446\u0438\u0439 \u043D\u0430 \u0440\u044B\u043D\u043A\u0435</h6></div></div><div class="md-toolbar-tools" hide-xs="hide-xs" show-gt-xs="show-gt-xs"><a class="brand-logo"><span>Chat Wars Market</span></a><md-button class="md-icon-button" aria-label="Settings" ng-click="vm.toggleSidenav()"><md-icon>menu</md-icon></md-button><h2>\u0421\u043F\u0438\u0441\u043E\u043A \u043E\u043F\u0435\u0440\u0430\u0446\u0438\u0439 \u043D\u0430 \u0440\u044B\u043D\u043A\u0435</h2></div></md-toolbar>');
$templateCache.put('template/container.html','<div layout="row" layout-fill="layout-fill"><div flex="flex" layout="column" md-swipe-right="vm.showSidenav()"><ui-view name="header"></ui-view><div ui-view="content" layout="column" style="overflow: auto;" ng-hide="isLoading"></div><ui-view name="footer"></ui-view></div></div>');
$templateCache.put('template/footer.html','<md-content layout="row" layout-align="space-around center"><a href="https://t.me/RedwingBot" target="blank">@RedwingBot</a><p>ChatWars &copy; 2017&nbsp;<a href="https://t.me/ChatWarsBot" target="blank">@ChatWarsBot</a></p><p>Created by&nbsp;<a href="https://t.me/shaurgon" target="blank">shaurgon</a></p></md-content>');}]);